<x-guess>
    <section class="bg-[#626f47] dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-4 py-2 mx-auto md:h-screen ">
            <img class="w-16 h-16 mr-2 mb-4" src="img/logo-ratou.png" alt="logo">
            <div class="w-full bg-[#f2eed7] rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-4 space-y-4 md:space-y-6 sm:p-6">
                    <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                        Create an account
                    </h1>
                    <form method="POST" action="/register" class="space-y-4 md:space-y-3">
                        @csrf
                        <div>
                        ...
                        <div>
                            <label for="confirm-password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Re-type password</label>

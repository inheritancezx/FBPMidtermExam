<x-layout>
    <div class="flex flex-col w-full gap-y-6 px-12 my-12">
        <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-8">
            <div class="mx-auto max-w-screen-lg px-6 2xl:px-0">
              ...
              <!-- <h2 class="mb-2 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl md:mb-2">General overview</h2> -->
              ...
              <div class="py-4 md:py-4 md:pt-6">
                <div class="mb-4 grid gap-4 sm:grid-cols-2 sm:gap-8 lg:gap-16">
                  <div class="space-y-4">
                    <div class="flex space-x-4 items-center">
                      <img class="h-16 w-16 rounded-lg" src="{{ asset('img/oreopudding.jpg') }}" alt="profile" />
                      <div>
                        <h2 class="flex items-center text-xl font-bold leading-none text-gray-900 dark:text-white sm:text-2xl">{{ Auth::user()->name }}</h2>
                        <h3 class="text-gray-500 dark:text-gray-400">{{ Auth::user()->email }}</h3>
                      </div>
                    </div>
                    <!-- <dl class="">
              ...
              <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800 md:p-8">
                <h3 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">My Recipes</h3>
                @foreach ($recipes as $recipe)
                <div class="flex justify-between items-center border-b border-gray-200 py-4 dark:border-gray-700">
                  <dl class="w-1/2 sm:w-48">
                    <dt class="text-base font-medium text-gray-50 dark:text-gray-800">name:</dt>
                    <dd class="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">
                      <a href="/profile/{{ $recipe->slug }}" class="hover:underline p-2">{{ $recipe->name }}</a> 
                    </dd>
                  </dl>
                  
                  
                  <dl class="w-1/2 sm:w-1/7 lg:w-auto">
                    <dt class="text-base font-medium text-gray-500 dark:text-gray-400">Course</dt>
                    <dd class="me-2 mt-1.5 inline-flex shrink-0 items-center rounded bg-gray-200 px-2.5 py-0.5 text-xs font-medium text-gray-800 dark:bg-yellow-900 dark:text-yellow-300">
                  ...
                  <dl class="w-1/2 sm:w-1/3 lg:w-auto">
                    <dt class="text-base font-medium text-gray-500 dark:text-gray-400">Category</dt>
                    <dd class="me-2 mt-1.5 inline-flex shrink-0 items-center rounded bg-{{ $recipe->category->color }}-100 px-2.5 py-0.5 text-xs font-medium text-{{ $recipe->category->color }}-800 dark:bg-yellow-900 dark:text-yellow-300">
                      <svg class="me-1 h-3 w-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h6l2 4m-8-4v8m0-8V6a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v9h2m8 0H9m4 0h2m4 0h2v-4m0 0h-5m3.5 5.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Zm-10 0a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z"></path>
                      </svg>
                  ...
                  <dl class="w-1/2 sm:w-1/5  lg:w-auto">
                    <dt class="text-base font-medium text-gray-500 dark:text-gray-400">est Price</dt>
                    <dd class="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">Rp{{ $recipe->est_price }}</dd>
                  </dl>

                  <dl class="w-1/2 sm:w-1/4 lg:w-auto">
                    <dt class="text-base font-medium text-gray-500 dark:text-gray-400">Last Edited at:</dt>
                    <dd class="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">    
                        {{ $recipe->created_at->format('H:i:s') }}
                        <br>
                  ...
                  <div class="w-full sm:flex sm:w-16 sm:items-center sm:justify-center sm:gap-4">
                    <!-- @dump($recipe->id) -->
                    <form action="{{ route('recipe.destroy', $recipe->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="group inline-flex w-full items-center rounded-md px-3 py-2 text-sm bg-white text-red-600 border border-red-600 hover:bg-red-600 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">
